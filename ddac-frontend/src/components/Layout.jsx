        ...
        <div className="flex min-h-screen bg-main">
            ...
            <div className="flex-1 flex flex-col ml-64">
                ...
                <header className="sticky top-0 z-10 bg-card border-b border-color px-8 py-4 shadow-md">
                        ...
                        {/*        <FaSearch className="absolute left-3 top-1/2 transform -translate-y-1/2 text-muted" size={20} />*/}
                        {/*        <input*/}
                        {/*            type="text"*/}
                        {/*            placeholder="Search..."*/}
                    ...
                    <div className="flex justify-end items-center gap-3">
                        ...
                        <div className="w-10 h-10 rounded-full bg-primary text-ondark
                      flex items-center justify-center font-semibold">
                            {(localStorage.getItem("userName") || "U")[0].toUpperCase()}
                        </div>
                        <button onClick={handleLogout} className="flex items-center gap-2 px-4 py-2 rounded-lg font-bold
