...
export default function ManagerNavBar() {
    ...
    return (
        <nav className="bg-primary text-text-ondark p-4">
            <div className="container">
                <button className="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent">Test</button>
            </div>
        </nav>
    );
