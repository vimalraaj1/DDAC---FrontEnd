        ...
        <Layout role="manager">
            <div className="w-full max-w-full overflow-hidden">
                ...
                <div className="mb-8 flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-bold text-heading">Edit Patient Information</h1>
                        <p className="text-muted mt-1">Update patient details</p>
                    </div>
                    <button
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="bg-card rounded-xl shadow-soft p-6 border border-color">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted">Basic details about the patient</p>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="md:col-span-2">
                                ...
                                <p className="text-xs text-muted mt-1 flex items-center gap-1">
                                    <span>🔒</span>
                                    <span>Patient ID cannot be modified</span>
                                </p>
                            </div>
                    ...
                    <div className="bg-card rounded-xl shadow-soft p-6 border border-color">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <div>
                                <h2 className="text-xl font-semibold text-heading">Medical Information</h2>
                                <p className="text-sm text-muted">Health conditions and medications</p>
                            </div>
                        </div>
                    ...
                    <div className="bg-card rounded-xl shadow-soft p-6 border border-color">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <div>
                                <h2 className="text-xl font-semibold text-heading">Emergency Contact</h2>
