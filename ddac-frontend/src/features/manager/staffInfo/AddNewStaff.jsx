        ...
        <Layout role="manager">
            <div className="w-full max-w-full overflow-hidden">
                ...
                <div className="mb-8 flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-bold text-heading">Add New Staff Member</h1>
                        <p className="text-muted mt-1">Fill in the details to register a new staff member</p>
                    </div>
                    <button
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="bg-card rounded-xl shadow-soft p-6 border border-color">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <div>
                                <h2 className="text-xl font-semibold text-heading">Employment Information</h2>
                                <p className="text-sm text-muted">Job role and department details</p>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    onChange={handleChange}
                                    className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary transition-all bg-card ${
                                        errors.department ? 'border-accent-danger' : 'border-input'
                                    }`}
                                >
                                ...
                                {errors.department && <p className="text-accent-danger text-xs mt-1">{errors.department}</p>}
                            </div>
