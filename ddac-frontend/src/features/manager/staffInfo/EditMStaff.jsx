...
import { FaUser, FaEnvelope, FaPhone, FaUserTie, FaIdCard, FaCalendar, FaMapMarkerAlt, FaArrowLeft, FaClock } from 'react-icons/fa';
...
export default function EditMStaff() {
    ...
    const status = ['Active', 'On-leave', 'Suspended'];
    ...
    const fetchStaffData = async () => {
        try {
            ...
            const mockData = {
                ...
                gender: 'female',
                address: '456 Staff Avenue, Kuala Lumpur',
                yearsOfExperience: '8',
            ...
            <Layout role="manager">
                <div className="flex items-center justify-center h-screen">
                    <div className="text-center">
                        ...
                        <p className="text-muted text-lg">Loading staff information...</p>
                    </div>
                </div>
            </Layout>
        );
        ...
        <Layout role="manager">
            <div className="w-full max-w-full overflow-hidden">
                ...
                <div className="mb-8 flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-bold text-heading">Edit Staff Information</h1>
                        <p className="text-muted mt-1">Update staff member details</p>
                    </div>
                    <button
                    ...
                    <div className="bg-card rounded-xl shadow-soft p-6 border border-color">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted">Basic details about the staff member</p>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="md:col-span-2">
                                ...
                                <p className="text-xs text-muted mt-1 flex items-center gap-1">
                                    <span>🔒</span>
                                    <span>Staff ID cannot be modified</span>
                                </p>
                            </div>
                    ...
                    <div className="bg-card rounded-xl shadow-soft p-6 border border-color">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted">Work-related details</p>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-heading mb-2">
                                    Role <span className="text-accent-danger">*</span>
                                </label>
                                <select
                                    name="role"
                                    value={formData.role}
                                    onChange={handleChange}
                                    className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary transition-all bg-card ${
                                        errors.role ? 'border-accent-danger' : 'border-input'
                                    }`}
                                >
                                ...
                                {errors.role && <p className="text-accent-danger text-xs mt-1">{errors.role}</p>}
                            </div>

                            {/* Department */}
                            <div>
                                <label className="block text-sm font-medium text-heading mb-2">
                                    Department <span className="text-accent-danger">*</span>
                                </label>
                                <select
                                    name="department"
