...
import DoctorAvailability from "../features/doctor/settings/DoctorAvailability";
  ...
  return (
    <BrowserRouter>
      ...
      <Route 
        ...
        <Route path="/doctorAvailability" element={<ProtectedRoute allowedRoles={['doctor']}><DoctorAvailability/></ProtectedRoute>}/>
